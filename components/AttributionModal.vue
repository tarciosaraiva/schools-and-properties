    ...
    <template #body>
      <ul>
        <li>
          ...
          <ul>
            <li>
              Checkout the Department of Education and Training's
              <a
                href="https://www.education.vic.gov.au/Pages/disclaimer.aspx"
                target="blank"
                >Disclaimer</a
              >
              and
        ...
        <li>
          ...
          <ul>
            <li>
              Checkout Better Education's
              <a
                href="https://www.bettereducation.com.au/Disclaimer.aspx"
                target="blank"
                >Disclaimer.</a
              >
            </li>
        ...
        <li>
          ...
          <ul>
            <li>Checkout Domain's Terms and Conditions.</li>
            <li>
              Checkout
              <a href="https://www.apm.com.au/terms-conditions/" target="blank"
                >APM's Terms and Conditions</a
              >.
            </li>
            <li>
              The State of Victoria owns the copyright in the Property Sales
              Data and reproduction of that data in any way without the consent
              of the state of Victoria will constitute a breach of the Copyright
              Act 1968 (Cth). The State of Victoria does not warrant the
              accuracy or completeness of the information contained in this
              report and any person using or relying upon such information does
              so on the basis that the State of Victoria accepts no
