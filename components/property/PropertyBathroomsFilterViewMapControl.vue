<template>
  <div class="layer-container">
    <button title="Show number of bathrooms filter control" @click="toggleControl">
      {{bathrooms}}
      <font-awesome-icon icon="bath" />
    </button>
    <button v-show="expanded" title="Query listings with current number of bathrooms filter" @click="handleChange">
